...
function createLinkElement(pageUrl, urlCase) {
    ...
    //reduces the array of recent links to be displayed to 15 links + current page
    linksArray = linksArray.slice(0, 16);
    //puts the <a> array into the recentLinksDiv
    recentLinksDiv.innerHTML = linksArray.slice(0, 16).join("‣"); 
